...
$result = mysqli_query($conn,"SELECT * FROM livre where ".$_POST['i']."='".$_POST['i1']."'");
...
<body>
    ...
    <form id="f" action="search.php" method="post">
        <h3>Search Bar</h3>
            ...
            <input name="i1" id="i1" type="text" placeholder="type to search ..."><br>
            <input name="i2" id="i2" type="submit" value="Search">
