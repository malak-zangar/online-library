...
$result = mysqli_query($conn,"SELECT * FROM user where cin_u='" . $_SESSION["user"]["cin_u"]. "'");
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p style="color:pink;font-size:50px;"> Information:</p>
			<?php
		...
		<tr>
            ...
            <td><a href="updateinf.php?cin=<?php echo $row["cin_u"]; ?>"><u>Update</u></a></td>
