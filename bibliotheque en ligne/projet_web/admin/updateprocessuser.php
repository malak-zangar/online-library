...
$result = mysqli_query($conn,"SELECT * FROM user WHERE cin_u='" . $_GET['cin_u'] . "'");
...
<form name="frmUser" method="post" action="">
    ...
    <input type="number" name="cin_u"  value="<?php echo $row['cin_u']; ?>">
    <br>
    name: <br>
    <input type="text" name="name_u" class="txtField" value="<?php echo $row['name_u']; ?>">
    <br>
    password :<br>
    <input type="password" name="password_u" class="txtField" value="<?php echo $row['password_u']; ?>">
    <br>
    status:<br>
    ...
    <br>
    phone:<br>
    <input type="number" name="phone_u" class="txtField" value="<?php echo $row['phone_u']; ?>">
    <br>
