...
$result = mysqli_query($conn,"SELECT * FROM empreinte");
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p style="color:pink;font-size:50px;"> Our empreints:</p>
			<?php
        ...
        <td><?php echo $row["num_emp"]; ?></td>
            ...
            <td><a href="deleteprocessemp.php?num_emp=<?php echo $row["num_emp"]; ?>"><u>Delete</u></a></td>
            <td><a href="updateprocessemp.php?num_emp=<?php echo $row["num_emp"]; ?>"><u>Update</u></a></td>
		</tr>
		<?php
		$i++;
		}
