...
<head>
    ...
    <script>
                     function f(a){
                       var v=(window.location.href).substr(window.location.href.indexOf('=')+1,(window.location.href).length-(window.location.href.indexOf('=')+1));
                        window.location=a+v;}
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <p style="color:pink;font-size:50px;"> Our books:</p>
			<?php
		...
		<tr>
            ...
            <td><a href="updateprocess.php?isbn=<?php echo $row["isbn"]; ?>"><u>Update</u></a></td>
