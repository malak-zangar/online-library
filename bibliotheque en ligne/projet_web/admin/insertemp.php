...
<form method="post" action="insertprocessemp.php" style="padding-left=100px;">
    <p style="color:pink;font-size:50px;"> Insert empreinte:</p>
		<label>num_emp:</label><br>
		<input type="number" name="num_emp">
		<br>
		<label>cin_us:</label><br>
		<input type="number" name="cin_us">
		<br>
        <label>isbn_l:</label><br>
		<input type="number" name="isbn_l">
		<br>
		<label>date_e:</label><br>
		<input type="date" name="date_e">
        <br>
		<label>date_r:</label><br>
